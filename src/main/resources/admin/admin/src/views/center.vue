  ...
  <div>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"padding":"0px","boxShadow":"0px 0px 0px 0px #d2b3aa","margin":"0 0 20px 0","borderColor":"#d3a7be","borderRadius":"0px","background":"#fff","borderWidth":"0px","display":"block","width":"100%","minWidth":"500px","borderStyle":"solid"}'   v-if="flag=='yonggongbumen'"  label="部门账号" prop="bumenzhanghao">
          <el-input v-model="ruleForm.bumenzhanghao" readonly              placeholder="部门账号" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"padding":"0px","boxShadow":"0px 0px 0px 0px #d2b3aa","margin":"0 0 20px 0","borderColor":"#d3a7be","borderRadius":"0px","background":"#fff","borderWidth":"0px","display":"block","width":"100%","minWidth":"500px","borderStyle":"solid"}'   v-if="flag=='yonggongbumen'"  label="部门名称" prop="bumenmingcheng">
          <el-input v-model="ruleForm.bumenmingcheng"               placeholder="部门名称" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"padding":"0px","boxShadow":"0px 0px 0px 0px #d2b3aa","margin":"0 0 20px 0","borderColor":"#d3a7be","borderRadius":"0px","background":"#fff","borderWidth":"0px","display":"block","width":"100%","minWidth":"500px","borderStyle":"solid"}'   v-if="flag=='yonggongbumen'"  label="负责人" prop="fuzeren">
          <el-input v-model="ruleForm.fuzeren"               placeholder="负责人" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"padding":"0px","boxShadow":"0px 0px 0px 0px #d2b3aa","margin":"0 0 20px 0","borderColor":"#d3a7be","borderRadius":"0px","background":"#fff","borderWidth":"0px","display":"block","width":"100%","minWidth":"500px","borderStyle":"solid"}'   v-if="flag=='yonggongbumen'"  label="联系电话" prop="lianxidianhua">
          <el-input v-model="ruleForm.lianxidianhua"               placeholder="联系电话" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"padding":"0px","boxShadow":"0px 0px 0px 0px #d2b3aa","margin":"0 0 20px 0","borderColor":"#d3a7be","borderRadius":"0px","background":"#fff","borderWidth":"0px","display":"block","width":"100%","minWidth":"500px","borderStyle":"solid"}'   v-if="flag=='yonggongbumen'"  label="部门地址" prop="bumendizhi">
          <el-input v-model="ruleForm.bumendizhi"               placeholder="部门地址" clearable></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if((!this.ruleForm.bumenzhanghao)&& 'yonggongbumen'==this.flag){
        this.$message.error('部门账号不能为空');
        return
      }
      if((!this.ruleForm.mima)&& 'yonggongbumen'==this.flag){
        this.$message.error('密码不能为空');
        return
      }
      if((!this.ruleForm.bumenmingcheng)&& 'yonggongbumen'==this.flag){
        this.$message.error('部门名称不能为空');
        return
      }
      if( 'yonggongbumen' ==this.flag && this.ruleForm.lianxidianhua&&(!isMobile(this.ruleForm.lianxidianhua))){
