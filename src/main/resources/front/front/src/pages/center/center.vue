    ...
    <el-tabs tab-position="left" :style='{"width":"100%","flexWrap":"wrap","background":"none","justifyContent":"center","display":"flex"}' @tab-click="handleClick">
      <el-tab-pane label="个人中心">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="110px">
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='xuesheng'" label="学号" prop="xuehao">
            <el-input v-model="sessionForm.xuehao" placeholder="学号" readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='xuesheng'" label="密码" prop="mima">
            <el-input type="password" v-model="sessionForm.mima" placeholder="密码"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='xuesheng'" label="学生姓名" prop="xueshengxingming">
            <el-input v-model="sessionForm.xueshengxingming" placeholder="学生姓名" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='xuesheng'" label="头像">
            <el-upload
          ...
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='xuesheng'" label="性别">
            <el-select v-model="sessionForm.xingbie" placeholder="请选择性别" >
              <el-option v-for="(item, index) in dynamicProp.xingbie" :key="index" :label="item" :value="item"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='xuesheng'" label="手机号码" prop="shoujihaoma">
            <el-input v-model="sessionForm.shoujihaoma" placeholder="手机号码" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='yonggongbumen'" label="部门账号" prop="bumenzhanghao">
            <el-input v-model="sessionForm.bumenzhanghao" placeholder="部门账号" readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='yonggongbumen'" label="密码" prop="mima">
            <el-input type="password" v-model="sessionForm.mima" placeholder="密码"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='yonggongbumen'" label="部门名称" prop="bumenmingcheng">
            <el-input v-model="sessionForm.bumenmingcheng" placeholder="部门名称" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='yonggongbumen'" label="负责人" prop="fuzeren">
            <el-input v-model="sessionForm.fuzeren" placeholder="负责人" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='yonggongbumen'" label="联系电话" prop="lianxidianhua">
            <el-input v-model="sessionForm.lianxidianhua" placeholder="联系电话" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='yonggongbumen'" label="部门地址" prop="bumendizhi">
            <el-input v-model="sessionForm.bumendizhi" placeholder="部门地址" ></el-input>
          </el-form-item>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      if ('yonggongbumen' == this.userTableName) {
        this.$set(this.sessionForm, 'bumenzhanghao', null);
      }
      if ('yonggongbumen' == this.userTableName) {
        this.$set(this.sessionForm, 'mima', null);
      }
      ...
      if ('yonggongbumen' == this.userTableName) {
        this.$set(this.sessionForm, 'bumendizhi', null);
      }
      ...
      if ('yonggongbumen' == this.userTableName) {
        this.$set(this.rules, 'bumenzhanghao', [{ required: true, message: '请输入部门账号', trigger: 'blur' }]);
      }
      if ('yonggongbumen' == this.userTableName) {
        this.$set(this.rules, 'mima', [{ required: true, message: '请输入密码', trigger: 'blur' }]);
      }
      if ('yonggongbumen' == this.userTableName) {
        this.$set(this.rules, 'bumenmingcheng', [{ required: true, message: '请输入部门名称', trigger: 'blur' }]);
      }
			if ('yonggongbumen' == this.userTableName) {
